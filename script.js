...
// ★ クイズデータ
const quiz = [
  { q: "日本で一番高い山は？", c: ["富士山", "北岳", "槍ヶ岳"],img: "images/sample-1.jpg" },
  { q: "寿司ネタで使われる「マグロ」の英語は？", c: ["Tuna", "Salmon", "Mackerel"] ,img: "images/sample-2.jpg"},
  { q: "千葉県の県庁所在地は？", c: ["千葉市", "船橋市", "柏市"],img: "images/sample-3.jpg" },
